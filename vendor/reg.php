...
<form action="" method="post">
  ФИО:<input type="text" placeholder="Иванов Иван Иванович" name="fullname" required> <br />
  Email:<input type="text" placeholder="account@mail.ru" name="email" required> <br /> 
  Логин:<input type="text" placeholder="login" name="login" required> <br /> 
  Пароль:<input type="text" placeholder="password" name="password" required> <br /> 
  <input type="submit"
  value="Зарегистрироваться">
</form>
<a href="auth.php" class="already-registered">Уже зарегистрированы?</a>
</body>
</html>